...
<div class="container-lg mx-auto about-content">
    <img class="mb-5 w-100" src="./public/img/placeholders/about-1.jpg" alt="about-us-illustrate">
    <h3 class="text-center">The idea</h3>
    <p class="text-center">
      Jewellery is an object of permanence, something that transcends the boundaries of age and time and that can be passed on from one generation to another.
    </p>
    <p class='text-center'>
      Founded by us, the Periphera company, the manager addresses the need to communicate directly with their clientele and to disrupt the old impersonal system. It is built to offer jewelry that is not just a family heirloom that may gather dust in bank vaults for the most part of its life but a beautiful object of adornment that echoes the sentiments and emotions of the wearer.
    </p>
    <img class="mb-5 w-100" src="./public/img/placeholders/about-2.jpg" alt="the-idea-illustrate">
    <h3 class="text-center">The meaning</h3>
    <p class="text-center">
